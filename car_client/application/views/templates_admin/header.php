...
<html lang="en">
  ...
  <head>
    <title>Car Rent | Admin Page</title>
    <meta charset="utf-8">
      ...
      <header class="site-navbar site-navbar-target" role="banner">
        ...
        <div class="container">
          <div class="row align-items-center position-relative">
            ...
            <div class="col-3 ">
              <div class="site-logo">
                <a href="<?php echo base_url('Admin/Beranda')?>">CarRent | Admin Page</a>
              </div>
            </div>
            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  <li class="active"><a href="<?php echo base_url('Admin/Beranda')?>">Home</a></li>
                  <?php if($this->session->userdata('nama')) { ?>
                  <li><a href="<?php echo base_url('Admin/Data_mobil')?>">Data Mobil</a></li>
                  <li><a href="<?php echo base_url('Admin/Data_type')?>">Data Type Mobil</a></li>
                  <li><a href="<?php echo base_url('Admin/Data_booking')?>">Data Peminjaman</a></li>
